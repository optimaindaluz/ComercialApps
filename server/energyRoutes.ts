    ...
    try {
      ...
      const clean = {
        ...
        invoice: {
          billingDays,
          currentInvoiceTotal,
          powerP1Kw: numberOrUndefined(invoice.powerP1Kw), powerP2Kw: numberOrUndefined(invoice.powerP2Kw),
          ...
          currentPowerTotalAmount: numberOrUndefined(invoice.currentPowerTotalAmount),
